...
def get_args_parser():
    ...
    parser.add_argument('--teacher_forcing', action="store_true", default=False,
                        help="teacher forcing training for vln")
    parser.add_argument('--max_action_len', type=int, default=7)
...
def main(args):
    ...
    #optimizer = AdamW(param_groups, lr=args.lr, betas=(0.9, 0.95),eps=1e-3)
    print(optimizer)
