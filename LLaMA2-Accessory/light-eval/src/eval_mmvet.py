...
def get_args_parser():
    ...
    parser.add_argument("--image_folder", type=str, default="/path/to/LLaMA2-Accessory/accessory/accessory_mm_eval/MM-vet/mm-vet/images")
    parser.add_argument("--question_file", type=str, default="/path/to/LLaMA2-Accessory/accessory/accessory_mm_eval/MM-vet/mm-vet/mm-vet.json")
