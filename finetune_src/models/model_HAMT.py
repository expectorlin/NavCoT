...
class VLNBertCMT(nn.Module):
    ...
    def forward(self, mode, txt_ids=None, txt_masks=None, txt_embeds=None, 
                ...
                ob_masks=None, return_states=False, position_id=None):
        ...
        if mode == 'language':
            ...
            if self.args.use_ig:
                act_logits, txt_embeds, hist_embeds, ob_embeds, ig_probs = self.vln_bert(
                    ...
                    ob_nav_types=ob_nav_types, ob_masks=ob_masks, position_id=position_id)
            else:
            ...
            if return_states:
                ...
                if self.args.use_ig:
                    return act_logits, states, ig_probs
                else:
                    return act_logits, states
            if self.args.use_ig:
                return act_logits, ig_probs
            else:
                return (act_logits, )
